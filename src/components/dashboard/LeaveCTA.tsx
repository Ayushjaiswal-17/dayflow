...
export function LeaveCTA({ onApply }: { onApply: () => void }) {
  return (
    <section
      ...
      className="flex flex-col gap-4 rounded-2xl bg-gradient-to-r from-pink-100 to-purple-300 px-6 py-6 sm:flex-row sm:items-center sm:justify-between sm:px-7"
    >
      <div>
