...
export function QuickAccessCard({
  ...
  const bg = tone === 'blue' ? 'from-blue-50' : 'from-purple-50'
  ...
  return (
    <article className={cn('flex flex-col rounded-2xl bg-gradient-to-b to-surface-0 p-5 shadow-card transition-shadow hover:shadow-card-lg sm:flex-row sm:items-center sm:gap-6', bg, border)}>
      ...
      <div className="flex flex-1 flex-col gap-3">
        ...
        <button
          onClick={() => navigate(to)}
          className={cn(
            'inline-flex w-fit items-center gap-1.5 rounded-xl px-4 py-2 text-sm font-semibold text-white transition-colors',
