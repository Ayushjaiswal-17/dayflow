    ...
    <div className="space-y-4">
      ...
      <Card className="p-5">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <NumberField id="work-days" label="Working Days / Week" value={cfg.workingDaysPerWeek} onChange={(n) => patch({ workingDaysPerWeek: Math.min(7, n) })} suffix="days" max={7} />
          <NumberField id="break-time" label="Break Time" value={cfg.breakTimeHours} onChange={(n) => patch({ breakTimeHours: Math.min(4, n) })} suffix="hrs" max={4} step={0.5} />
        </div>
      </Card>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Card className="p-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            <NumberField id="pf-rate" label="PF Rate" value={cfg.pfRate} onChange={(n) => patch({ pfRate: Math.min(24, n) })} suffix="% of Basic" max={24} />
